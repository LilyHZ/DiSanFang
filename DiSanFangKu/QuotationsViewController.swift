...
class QuotationsViewController: UITableViewController ,MFMailComposeViewControllerDelegate,SectionHeaderViewDelegate{
        ...
        override func tableView(tableView: UITableView, cellForRowAtIndexPath indexPath: NSIndexPath) -> UITableViewCell {
            ...
            if MFMailComposeViewController.canSendMail() {
                ...
                if cell.longPressRecognizer == nil {
                    let longPressRecognizer: UILongPressGestureRecognizer = UILongPressGestureRecognizer(target: self, action: "handleLongPress:")
        ...
        func sectionHeaderView(sectionHeaderView: SectionHeaderView, sectionOpened: Int) {
            ...
            self.tableView.deleteRowsAtIndexPaths(indexPathsToDelete.copy() as! [NSIndexPath], withRowAnimation: deleteAnimation)
            self.tableView.insertRowsAtIndexPaths(indexPathsToInsert.copy() as! [NSIndexPath], withRowAnimation: insertAnimation)
        ...
        func sectionHeaderView(sectionHeaderView: SectionHeaderView, sectionClosed: Int) {
            ...
            if countOfRowsToDelete > 0 {
                ...
                self.tableView.deleteRowsAtIndexPaths(indexPathsToDelete.copy() as! [NSIndexPath], withRowAnimation: UITableViewRowAnimation.Top)
            }
            self.opensectionindex = NSNotFound
        }
        ...
        func sendEmailForEntryAtIndexPath(indexPath: NSIndexPath) {
            ...
            print("用以下语录发送邮件: \(quotation.quotation)", terminator: "")
        }
        ...
        func played() -> NSArray {
            ...
            if playe == nil {
                ...
                for playDictionary in playDictionariesArray! {
                    ...
                    let quotationDictionaries:NSArray = playDictionary["quotations"] as! NSArray
                    let quotations = NSMutableArray(capacity: quotationDictionaries.count)
                    
                    for quotationDictionary in quotationDictionaries {
                        
                        let quotationDic = quotationDictionary as! [String:AnyObject]//NSDictionary
